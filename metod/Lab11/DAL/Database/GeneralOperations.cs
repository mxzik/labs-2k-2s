...
namespace DAL.Operations
{
    public static class GeneralOperations
    {
        ...
        {
            string path = @"D:\лабы\2 sem\oop\metod\Lab11\DAL\Database\Scripts\CreateTeachersTable.sql";
        ...
        {
            string path = @"D:\лабы\2 sem\oop\metod\Lab11\DAL\Database\Scripts\DropTeachersTable.sql";
            string query = _parser.ParseScript(path);
            if (!string.IsNullOrWhiteSpace(query))
            {
                using (connection = new SQLiteConnection(_connectionString))
        ...
        public static void CreateDb()
        {
            ...
            String pathToDb2 = @"D:\лабы\2 sem\oop\metod\Lab11\Lab11\bin\Debug" + $"\\{dbName}";
