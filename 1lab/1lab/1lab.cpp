...
// 1lab.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMy1labApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CMy1labApp::OnAppAbout)
...
CMy1labApp::CMy1labApp() noexcept
{
	...
	SetAppID(_T("My1lab.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CMy1labApp

CMy1labApp theApp;


// Инициализация CMy1labApp

BOOL CMy1labApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_My1labTYPE,
		RUNTIME_CLASS(CMy1labDoc),
		RUNTIME_CLASS(CChildFrame), // настраиваемая дочерняя рамка MDI
		RUNTIME_CLASS(CMy1labView));
	if (!pDocTemplate)
		return FALSE;
...
// Обработчики сообщений CMy1labApp
...
void CMy1labApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Методы загрузки или сохранения настроек CMy1labApp

void CMy1labApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CMy1labApp::LoadCustomState()
{
}

void CMy1labApp::SaveCustomState()
{
}
